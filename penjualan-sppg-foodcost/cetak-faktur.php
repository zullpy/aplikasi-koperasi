...
if (empty($items)) {
    die("Tidak ada item foodcost untuk transaksi ini");
}
?>
<!DOCTYPE html>
<html>
...
<body>
    ...
    <!-- ===== JUDUL ===== -->
    <div class="judul">FAKTUR PENJUALAN FOODCOST</div>
    ...
    <table class="catatan-table">
        <tr>
            ...
            <td class="catatan-isi">
                Faktur ini merupakan bukti pengambilan barang foodcost SPPG<br>
