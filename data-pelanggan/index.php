...
<body>
    ...
    <header class="page-header">
        <div class="page-header-left">
            ...
            <div>
                <div class="header-title">Data Pelanggan</div>
                <div class="header-subtitle">Kelola daftar pelanggan</div>
            </div>
        </div>
        <a href="../data-supplier/index.php" class="header-back">
            <i class="ti ti-building-store"></i> Ke Supplier
        </a>
    </header>
        ...
        <div class="modal">
            <div class="modal-header">
                <div class="modal-header-left">
                    <div class="modal-icon" id="modal-icon"><i class="ti ti-users"></i></div>
                    <span class="modal-title" id="modal-title">Tambah Pelanggan</span>
                </div>
                <button class="modal-close" onclick="closeModal()"><i class="ti ti-x"></i></button>
            </div>
            <div class="form-group">
                <label class="form-label" for="f-nama">Nama Pelanggan</label>
                <input type="text" id="f-nama" placeholder="Contoh: Budi Santoso" />
            </div>
            <div class="form-group">
                <label class="form-label" for="f-kontak">No. Kontak</label>
                <input type="number" id="f-kontak" placeholder="Contoh: 081399887766" />
            </div>
            <div class="form-group">
    ...
    <div class="confirm-overlay" id="confirm-overlay">
        <div class="confirm-box">
            ...
            <div class="confirm-title">Hapus Pelanggan?</div>
