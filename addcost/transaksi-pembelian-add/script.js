...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (tambahForm) {
        tambahForm.addEventListener('submit', (e) => {
            // ✅ PENTING: Cegah submit default DULUAN
            e.preventDefault();
            ...
            Swal.fire({
                ...
                <div style="text-align:left; font-size:0.9rem; line-height:1.6;">
                    <p>Data yang diinput ini <b>sudah benar?</b></p>
                </div>
            `,
                ...
                // ✅ Kalau user klik "Ya, Simpan", baru submit manual
                if (result.isConfirmed) {
                    tambahForm.submit();
                }
                // Kalau klik "Batal", ga terjadi apa-apa
            });
        });
    }
